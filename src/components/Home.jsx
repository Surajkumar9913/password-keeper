        ...
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                <h1 className="text-4xl text font-bold text-center">
                    ...
                    <span>Pass</span>
                    <span className="text-yellow-400">Keeper/&gt;</span>
                </h1>
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button
                        ...
                        className="flex justify-center items-center gap-2 font-bold text-white bg-yellow-400 hover:bg-yellow-500 rounded-full px-6 py-2 w-fit border border-blue-950"
                    >
                        <lord-icon
                ...
                <div className="passwords">
                    <h2 className="font-bold text-2xl py-4">All Passwords</h2>
